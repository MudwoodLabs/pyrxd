...
- **DAA modes** — the five difficulty-adjustment-algorithm modes a dMint V2
  ...
  [`src/pyrxd/glyph/dmint/types.py:151`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/types.py)):
...
- **difficulty vs target** — **the sharpest trap in the dMint math; get this
  ...
  ([`src/pyrxd/glyph/dmint/types.py:75`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/types.py)),
  ...
  - `target_to_difficulty(target) = MAX_SHA256D_TARGET // target`
    ([`src/pyrxd/glyph/dmint/miner.py:673`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/miner.py))
