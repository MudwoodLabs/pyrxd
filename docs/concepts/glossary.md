...
- **DAA modes** — the five difficulty-adjustment-algorithm modes a dMint V2
  ...
  [`src/pyrxd/glyph/dmint/types.py:117`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/types.py)):
...
- **difficulty vs target** — **the sharpest trap in the dMint math; get this
  ...
  ([`src/pyrxd/glyph/dmint/types.py:65`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/types.py)),
  ...
  - `target_to_difficulty(target) = MAX_SHA256D_TARGET // target`
    ([`src/pyrxd/glyph/dmint/miner.py:548`](https://github.com/MudwoodLabs/pyrxd/blob/main/src/pyrxd/glyph/dmint/miner.py))
