...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "WAVE_TREASURY_ADDRESS": ("pyrxd.glyph.wave_rules", "WAVE_TREASURY_ADDRESS"),
    "WaveRegistrationFee": ("pyrxd.glyph.wave_rules", "WaveRegistrationFee"),
    "wave_registration_fee_for": ("pyrxd.glyph.wave_rules", "wave_registration_fee_for"),
    "wave_registration_price": ("pyrxd.glyph.wave_rules", "wave_registration_price"),
    ...
    "build_burn_proof_script": ("pyrxd.glyph.burn", "build_burn_proof_script"),
    ...
    "verify_burn": ("pyrxd.glyph.burn", "verify_burn"),
