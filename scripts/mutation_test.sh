...
group_tests() {
  ...
  case "$1" in
    ...
    verdicts)    echo "tests/test_authority_tokens.py tests/test_dat_and_burn.py tests/test_delegate_refs_authorise_in_and_by.py tests/test_form2_security_hardening.py tests/test_wave_identity_form2.py tests/test_mark_anchor.py tests/test_mutable_chain_walk.py tests/test_wave_fold_fixture_discriminates.py tests/test_relationship_claims_are_verified.py tests/test_inspect_core_classification.py tests/test_fuzz_parsers.py tests/cli/test_glyph_inspect_cmds.py tests/test_multi_glyph_reveal_attribution.py tests/web/test_inspect_imports_pyodide_clean.py tests/test_confusables_check_is_actually_wired.py tests/test_hashmark_attestation.py" ;;
    btcleg)      echo "tests/test_watch_claim_executor.py tests/test_builder_relay_fee_floors.py tests/test_btc_htlc_leg.py tests/test_btc_chains.py tests/test_btc_wallet.py tests/test_watch_v2_execute_invariants.py tests/test_swap_coordinator.py tests/test_two_host_recovery_phases.py tests/test_watchtower_dust_run_harness.py tests/test_remaining_builder_relay_fee_floors.py tests/test_btc_maker_counter_funding_adversarial.py tests/test_btc_taproot.py tests/test_taker_asset_funding_gate_adversarial.py tests/test_swap_gate_binding.py tests/test_watch_quorum.py tests/cli/test_swap_recovery.py" ;;
    covenants)   echo "tests/test_rswp_covenant.py tests/test_gravity_red_team.py tests/cli/test_swap_recovery_cmds.py tests/test_radiant_leg.py tests/test_rswp_covenant_ft_demand.py tests/test_inspect_script_shapes.py tests/test_ref_walker_differential.py tests/test_two_host_recovery_phases.py tests/test_covenant.py tests/test_gravity_maker.py tests/test_gravity_maker_offer.py tests/test_htlc_refund_ft_nft_coverage.py tests/test_htlc_spend_productized.py tests/cli/test_swap_recovery.py tests/test_htlc_spend_fee_floor.py tests/test_htlc_covenant.py" ;;
    gravitycore) echo "tests/test_gravity_trade.py tests/test_gravity_maker.py tests/test_gravity_fee_policy.py tests/test_gravity_maker_offer.py tests/test_swap_coordinator.py tests/test_remaining_builder_relay_fee_floors.py tests/test_reorg_cost_measurement.py tests/test_eth_leg.py tests/test_gravity_red_team.py tests/test_two_host_recovery_phases.py tests/test_watch_claim_executor.py tests/test_watch_decide.py tests/test_radiant_leg.py tests/test_watch_v2_execute_invariants.py tests/test_watch_pages_name_state_valid_steps.py tests/test_gravity.py" ;;
    cryptoprim)  echo "tests/test_crypto_aead.py tests/test_crypto_kem.py tests/test_aes_cbc.py tests/test_curve.py tests/test_keys.py tests/test_hash.py tests/security/test_rng.py tests/security/test_types.py tests/test_glyph_timelock_write_side_is_reachable.py tests/test_coverage_gaps2.py tests/test_bip44_conformance_vectors.py tests/test_btc_htlc_leg.py tests/security/test_reveal_boundary_survives_cancellation.py tests/security/test_hostile_server_responses.py tests/web/test_inspect_imports_pyodide_clean.py tests/test_glyph_mint_facade.py" ;;
    glyphverify) echo "tests/test_glyph_royalty.py tests/test_glyph_scanner.py tests/test_glyph_wave.py tests/test_creator_signature_verifies_the_signed_bytes.py tests/test_credential_binding.py tests/test_form2_security_hardening.py tests/test_inspect_script_shapes.py tests/test_glyph_mint_facade.py tests/test_confusables.py tests/cli/test_glyph_inspect_cmds.py tests/cli/test_glyph_cmds.py tests/test_dmint_v1_deploy.py tests/test_glyph_timelock_write_side_is_reachable.py tests/test_inspect_core_classification.py tests/test_glyph_reveal_fees.py tests/test_glyph_v2_metadata.py" ;;
    glyphlock)   echo "tests/test_glyph_timelock.py tests/test_glyph_timelock_reveal_tx.py tests/test_dmint_estimate.py tests/test_glyph_timelock_write_side_is_reachable.py tests/test_glyph_mint_facade.py tests/cli/test_glyph_estimate_cmds.py tests/test_timelock_reveal_evidence_and_durability.py tests/test_timelock_irreversible_paths_are_gated_and_visible.py tests/test_glyph_reveal_fees.py tests/test_encrypted_content_types.py tests/cli/test_glyph_cmds.py tests/test_decode_survives_a_hostile_crypto_block.py tests/test_glyph_client_transfer.py tests/test_glyph_timelock_read_side_is_reachable.py tests/test_sign_metadata_preserves_every_field.py tests/test_decode_survives_hostile_numeric_cbor.py" ;;
    wire)        echo "tests/test_compactsize.py tests/test_merkle_path.py tests/test_script_consensus.py tests/test_rswp_wire.py tests/test_watch_claim_executor.py tests/test_coverage_gaps4.py tests/test_ref_walker_differential.py tests/test_hashmark_attestation.py tests/test_message_data_carrier.py tests/test_rswp_orders.py tests/cli/test_swap_recovery_cmds.py tests/test_radiant_leg.py tests/test_two_host_recovery_phases.py tests/test_inspect_script_shapes.py tests/test_htlc_refund_ft_nft_coverage.py tests/test_dmint_v1_mint.py" ;;
    hdseed)      echo "tests/test_hd_discovery.py tests/test_bip44_conformance_vectors.py tests/test_hd.py tests/test_hd_wallet.py tests/test_hd_descriptor.py tests/cli/test_wallet_cmds.py tests/cli/test_glyph_cmds.py tests/cli/test_wallet_sweep.py tests/cli/test_query_cmds.py tests/cli/test_security_paths.py tests/test_agent_signer.py tests/cli/test_wallet_recover.py tests/security/test_key_material_never_echoed.py tests/test_agent_watch_only.py tests/cli/test_glyph_airdrop_cmd.py tests/test_agent_daemon.py" ;;
    ...
    walletcore)  echo "tests/test_swap_partial.py tests/test_swap_resolve.py tests/test_hd_wallet.py tests/cli/test_swap_fee_sizing.py tests/web/test_inspect_imports_pyodide_clean.py tests/test_swap_partial_nft.py tests/test_rswp_orders.py tests/test_rswp_tracker.py tests/test_swap_and_nft_fee_floors.py tests/test_rswp_book.py tests/test_remaining_builder_relay_fee_floors.py tests/cli/test_swap_book_cmds.py tests/test_rswp_covenant_ft_demand.py tests/test_rswp_rxindexer_source.py tests/cli/test_swap_covenant_cmds.py tests/test_rswp_covenant.py" ;;
